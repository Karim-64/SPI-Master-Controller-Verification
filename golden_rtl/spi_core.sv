...
// // =============================================================================
// // spi_core_fixed.sv  — LOCAL DEBUG ONLY, DO NOT SUBMIT
// // -----------------------------------------------------------------------------
// // Fix: MISO is now sampled one PCLK cycle AFTER the sample edge fires,
// // giving the slave time to settle before capture.
// // =============================================================================
...
// //     // FIX: registered sample/launch intent flags
// //     reg        do_sample;
// //     reg        do_launch;
// //     reg        do_first_cpha1;
...
// //             // Clear one-shot flags every cycle
// //             do_sample      <= 1'b0;
// //             do_launch      <= 1'b0;
// //             do_first_cpha1 <= 1'b0;
...
// //                     // --------------------------------------------------------
// //                     // SHIFT
// //                     // FIX: separate edge-detection (sets do_sample/do_launch)
// //                     //      from actual sample (reads miso_eff next cycle).
// //                     // --------------------------------------------------------
// //                     S_SHIFT: begin

// //                         // --- Step 1: Act on previous cycle's intent flags ---

// //                         // FIX: Sample MISO one cycle after the sample edge
// //                         // so MISO has had a full half-period to settle.
// //                         if (do_sample) begin
// //                             if (xfer_lsb_first)
// //                                 sh_rx[width_bits - bit_cnt] <= miso_eff;
// //                             else
...
// //                         // CPHA=1 first-bit launch (one cycle after first edge)
// //                         if (do_first_cpha1) begin
// //                             MOSI <= get_tx_bit(sh_tx, bit_cnt,
// //                                                width_bits, xfer_lsb_first);
// //                         end

// //                         // --- Step 2: Detect edges, set flags for next cycle ---
// //                         if (sclk_cnt == half_period - 1) begin
// //                             sclk_cnt   <= 17'h0;
// //                             sclk_phase <= ~sclk_phase;
// //                             SCLK       <= ~SCLK;
...
// //                                 // FIX: register intent, act next cycle
// //                                 do_sample <= is_sample_edge;
// //                                 do_launch <= is_launch_edge;

// //                                 // CPHA=1: flag first-bit launch separately
// //                                 if (cpha == 1'b1 && leading && bit_cnt == width_bits)
// //                                     do_first_cpha1 <= 1'b1;
// //                             end
// //                         end else begin
// //                             sclk_cnt <= sclk_cnt + 17'h1;
