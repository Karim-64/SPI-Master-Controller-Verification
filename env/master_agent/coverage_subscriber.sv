package coverage_subscriber_pkg;
  ...
  class coverage_subscriber extends uvm_subscriber #(master_sequence_item);
    ...
    covergroup cg_apb_silent_failures;
        ...
        cp_illegal_access: cross cp_paddr, cp_pwrite {
    ...
    covergroup cg_disabled_ops;
        ...
        cp_push_while_disabled: cross cp_tx_write, cp_enable_state {
    ...
    // triggered whenever the monitor sends an item
    virtual function void write(master_sequence_item t);
      this.seq_item_cov = t;

      // Avoid the mutual exclusive conditions of the address
      // Check if enable is asserted before 
