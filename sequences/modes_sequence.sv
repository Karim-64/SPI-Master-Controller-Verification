    ...
    class modes_crossing_sequence extends uvm_sequence #(master_sequence_item);
        ...
        task body();
            ...
            repeat(30) begin
                ...
                apb_write(this, 8'h00,{24'h0, cfg_item.width_cfg_r, 1'b0, cfg_item.lsb_first_r, cfg_item.mode_r, 2'b11});

                //assert ss_n
                apb_write(this, 8'h14, {28'h0,cfg_item.ss_n_r});
                //push data 
                apb_write(this, 8'h08, cfg_item.data_r);
