package error_enjection_sequence_pkg;
    ...
    class error_enjection_sequence extends uvm_sequence #(master_sequence_item);
        ...
        task body();
            ...
            // - Returns 0
            // - RX_OVF is NOT set 
            // - PSLVERR stays always 0

            apb_read(APB_RX_DATA);  // expect PRDATA = 32'b0
            ...
            // SCENARIO 3: RX FIFO Overflow will be asserted using loopback 
            // Expected:
            ...
            // SCENARIO 5: Reserved Offset Access 
            // Reads return 0, writes ignored
            apb_write_reset();
            apb_write(APB_CTRL, 32'h0000_0003); //CTRL value

            // Write into reserved addresses
            apb_write(8'h24, 32'hAAAA_BBBB);   
            apb_write(8'hFF, 32'hCCCC_DDDD);   
            ...
            apb_read(APB_STATUS); // TX_EMPTY must still be 1
