package error_injection_test_pkg;
import uvm_pkg::*;
...
class error_injection_test extends uvm_test;
    ...
    error_rst_sequence       rst_seq;
    error_enjection_sequence ctr_req;
    ...
    function void build_phase(uvm_phase phase);
        ...
        rst_seq               = error_rst_sequence::type_id::create("rst_seq");
        ctr_req               = error_enjection_sequence::type_id::create("ctr_req");
