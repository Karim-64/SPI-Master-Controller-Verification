...
class sanity_test extends uvm_test;
    ...
    sanity_rst_sequence rst_seq;
    sanity_ctrl_sequence ctr_req;
    ...
    function void build_phase(uvm_phase phase);
        ...
        rst_seq               = sanity_rst_sequence::type_id::create("rst_seq");
        ctr_req               = sanity_ctrl_sequence::type_id::create("ctr_req");
