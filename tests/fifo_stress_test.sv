package master_fifo_stress_pkg;
...
class master_fifo_stress_test extends uvm_test;
    `uvm_component_utils(master_fifo_stress_test)
    master_env env;
    ...
    function new(string name = "master_fifo_stress_test",uvm_component parent = null);
    ...
    task run_phase (uvm_phase phase);
        ...
        `uvm_info("run_phase","fifo_stress_seq stimulus generation started",UVM_LOW)
            fifo_stress_seq.start(env.agent.sqr);
        `uvm_info("run_phase","fifo_stress_seq stimulus generation ended",UVM_LOW)
