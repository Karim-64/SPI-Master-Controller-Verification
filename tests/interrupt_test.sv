...
class master_interrupts_test extends uvm_test;
    `uvm_component_utils(master_interrupts_test)
    master_env env;
    ...
    function new(string name = "master_interrupts_test",uvm_component parent = null);
    ...
    function void build_phase (uvm_phase phase);
       ...
       interrupts_seq = master_interrupts_sequence::type_id::create("interrupts_seq");  
