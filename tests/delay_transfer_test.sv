package delay_transfer_test_pkg;
...
class delay_transfer_test extends uvm_test;
    ...
    delay_transfer_rst_sequence rst_seq;
    delay_transfer_sequence ctr_req;

    function new(string name = "delay_transfer_test",uvm_component parent = null);
    ...
    function void build_phase(uvm_phase phase);
        ...
        rst_seq               = delay_transfer_rst_sequence::type_id::create("rst_seq");
        ctr_req               = delay_transfer_sequence::type_id::create("ctr_req");
